...
import com.chz.entity.AjaxResult;
import com.chz.transfer.MediaVideoTransfer;
...
public class IndexController {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        AjaxResult ajaxResult = indexController.putVideoPath("C:\\videos\\bandicam 2024-05-13 22-21-07-965.mp4");
        indexController.write((int) ajaxResult.get("data"), new FileOutputStream("C:\\videos\\bandicam 2024-05-13 22-21-07-965.flv"));
    }
}